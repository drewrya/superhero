...
function Init() {
    d3.csv("/data/powerstats.csv").then(function(herodata){
        ...
        var dc_top_Avg = dc_Avg.slice(0,25)
        ...
        var marvel_top_Avg = marvel_Avg.slice(0,25);
...
function IntFilter() {
    d3.csv("/data/powerstats.csv").then(function(herodata){
        ...
        var dc_top_Int = dc_Int.slice(0,25)
        // console.log(dc_top_Int)
        ...
        var marvel_top_Int = marvel_Int.slice(0,25);
...
function StrFilter() {
    d3.csv("/data/powerstats.csv").then(function(herodata){
        ...
        var dc_top_Str = dc_Str.slice(0,25)
        // console.log(dc_top_Int)
        ...
        var marvel_top_Str = marvel_Str.slice(0,25);
...
function SpeFilter() {
    d3.csv("/data/powerstats.csv").then(function(herodata){
        ...
        var dc_top_Speed = dc_Speed.slice(0,25)
        // console.log(dc_top_Int)
        ...
        var marvel_top_Speed = marvel_Speed.slice(0,25);
...
function DuraFilter() {
    d3.csv("/data/powerstats.csv").then(function(herodata){
        ...
        var dc_top_Dura = dc_Dura.slice(0,25)
        // console.log(dc_top_Int)
        ...
        var marvel_top_Dura = marvel_Dura.slice(0,25);
...
function PwrFilter() {
    d3.csv("/data/powerstats.csv").then(function(herodata){
        ...
        var dc_top_Pwr = dc_Pwr.slice(0,25)
        // console.log(dc_top_Int)
        ...
        var marvel_top_Pwr = marvel_Pwr.slice(0,25);
...
function ComFilter() {
    d3.csv("/data/powerstats.csv").then(function(herodata){
        ...
        var dc_top_Com = dc_Com.slice(0,25)
        // console.log(dc_top_Int)
        ...
        var marvel_top_Com = marvel_Com.slice(0,25);
